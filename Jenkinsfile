pipeline {
    ...
    stages {
        ...
        stage('SCA') {
            steps {
                echo 'SCA..'
                dependencyTrackPublisher artifact: 'pom.xml', projectName: 'tmp', projectVersion: '0.1', synchronous: true, autoCreateProjects: true, failedTotalCritical: 0, failedTotalHigh: 1, failedTotalMedium: 2
            }
        }
        stage('Results') {
            steps {
